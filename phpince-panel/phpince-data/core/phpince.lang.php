...
$PHPINCE_LANG = array(
	...
	//Webadmin
		...
		11 => "Áno",
		12 => "Nie",
		13 => "Aktualizácia webstánky prebezhne za", //?? seconds
		14 => "Články",
		15 => "Stránky",
		16 => "Súbory",
		17 => "Používatelia",
	...
	//Login system
		100 => "Prihlásenie",
		101 => "Prosím, vyplnte účet a heslo.",
		102 => "Prihlásenie",
		...
		127 => "Váš overovací klúč k obnoveniu hesla je:",
		128 => "Svoje heslo si môžte uplatniť tu:",
		129 => "Obnova hesla prebehla úspešne, na E-Mail bol odoslaný aktivačný klúč:",
		130 => "Klúč",
		131 => "Zadaný aktivačný klúč neexistuje alebo uplynula jeho platnosť.",
		132 => "Obnova hesla prebehla úspešne.<br>Prebieha automatické presmerovanie ...",
		133 => "Odhlásenie",
	//Error pages
		200 => "Prístup zablokovaný",
		201 => "Vaša IP adresa bola zablokovaná, viac info čítajte tu:",
		202 => "Vaša IP adresa bola zablokovaná na {BAN_TIME} minút. Dôvodom tohto zablokovania je veľký počet neuhádnutia hesla k účtu.",
		203 => "Na web-stránke sa pracuje",
		204 => "Ospravedlňujeme sa, ale na webovovej stránké sa pracuje. Navštívte prosím túto stránku neskôr.",
	//Webadmin: Home
		300 => "Administrácia",
		...
		305 => "Verzia systému",
		306 => "Verzia jadra",
		307 => "Štatistika webstránky",
		308 => "Počet článkov",
		309 => "Počet stránok",
		310 => "Počet užívatelov",
	...
	//Webadmin: Settings
		...
		506 => "Formát času",
		507 => "hodín",
		508 => "Povoliť registráciu nových uživatelov",
		...
		522 => "Bezpečnosť",
		523 => "Blokovať prihlasenie pri nesprávnom hesle",
	...
	//Webadmin: Files
		...
		802 => "Názov súboru",
		803 => "Velkosť",
		804 => "Upload prebehol úspešne",
		805 => "Nebol najdený žiaden súbor.",
	...
	//Webadmin: Users
		...
		1305 => "Posledná IP",
		1306 => "Vypňte polia v strávnom formáte",
		1307 => "Upravil užívatela",
		1308 => "Zmenil heslo užívatelovy",
	//Webadmin: Pages
		1400 => "Stránky",
		1401 => "Vytvoriť novú",
		1402 => "Názov stránky",
		...
		1404 => "Autor",
		1410 => "Neboly vytvorené žiadne stránky.",
	...
	//Webadmin: News
		...
		1509 => "Zmazal článok:",
		1510 => "Neboly vytvorené žiadne články.",
		1511 => "Nezaradené",
		1512 => "Kategória",
		1513 => "Kategórie",
		1514 => "Vytvoriť novú",
		...
		1522 => "Neboly vytvorené žiadne kategórie",
	//Webadmin: Apps
		1600 => "Moduly",
